...
const (
	...
	AuthServiceName = "apex20.v1.AuthService"
)
...
const (
	...
	AuthServiceSignUpProcedure = "/apex20.v1.AuthService/SignUp"
	// AuthServiceSignInProcedure is the fully-qualified name of the AuthService's SignIn RPC.
	AuthServiceSignInProcedure = "/apex20.v1.AuthService/SignIn"
)

// AuthServiceClient is a client for the apex20.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the apex20.v1.AuthService service. By default, it
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := v1.File_proto_apex20_v1_auth_proto.Services().ByName("AuthService").Methods()
...
// SignUp calls apex20.v1.AuthService.SignUp.
...
// SignIn calls apex20.v1.AuthService.SignIn.
...
// AuthServiceHandler is an implementation of the apex20.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/apex20.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) SignUp(context.Context, *connect.Request[v1.SignUpRequest]) (*connect.Response[v1.SignUpResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("apex20.v1.AuthService.SignUp is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) SignIn(context.Context, *connect.Request[v1.SignInRequest]) (*connect.Response[v1.SignInResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("apex20.v1.AuthService.SignIn is not implemented"))
}
